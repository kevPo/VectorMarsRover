...
namespace MarsRover.Tests.States.Tests
{
    ...
    public class FacingWestTests
    {
        ...
        {
            var rover = new Rover(new Point { X = 0, Y = 0 }, 'W', stateFactory, planet);
            rover.MoveForward();
        ...
        {
            var rover = new Rover(new Point { X = -50, Y = 0 }, 'W', stateFactory, planet);
            rover.MoveForward();
        ...
        public void TestEnountersObstructionAndDoesNotMoveForward()
        {
            ...
            var rover = new Rover(new Point { X = 0, Y = 0 }, 'W', stateFactory, planetWithObstruction);
            rover.MoveForward();
        ...
        public void TestEncounterObstacleOnOtherSideOfAxisAndDoesNotMoveForward()
        {
            ...
            var rover = new Rover(new Point { X = -25, Y = 0 }, 'W', stateFactory, planetWithObstruction);
            rover.MoveForward();
