...
namespace MarsRover.Tests.States.Tests
{
    ...
    public class FacingSouthTests
    {
        ...
        {
            var rover = new Rover(new Point { X = 0, Y = 0 }, 'S', stateFactory, planet);
            rover.MoveForward();
        ...
        {
            var rover = new Rover(new Point { X = 0, Y = -50 }, 'S', stateFactory, planet);
            rover.MoveForward();
        ...
        public void TestEnountersObstructionAndDoesNotMoveForward()
        {
            ...
            var rover = new Rover(new Point { X = 0, Y = 0 }, 'S', stateFactory, planetWithObstruction);
            rover.MoveForward();
        ...
        public void TestEncounterObstacleOnOtherSideOfAxisAndDoesNotMoveForward()
        {
            ...
            var rover = new Rover(new Point { X = 0, Y = -25 }, 'S', stateFactory, planetWithObstruction);
            rover.MoveForward();
